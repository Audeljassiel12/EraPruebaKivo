...
namespace CentroMedico.Models.Dominio
{
    public class Paciente
    {
        ...
        [Requerid(ErrorMensage = "Los {0} son requeridos para el siguiente paso ")]
        ...
        [Requerid(ErrorMensage = "Los {0} son requeridos para seguir el siguiente paso")]
        ...
        [Requerid(ErrorMensague = "La fecha de nacimiento es requerida para seguir el siguiente paso")] 
        ...
        [Requerid(ErorMensage = "El {0} es requerido para el siguiente paso")]
        [StringLength(maximumLength: 1, MinimumLength = 1, ErrorMessage = "Valor no válido. Ingrese 'M' para Masculino, 'F' para Femenino. ")]
        public string Sexo { get; set; }  = null!;
        public string Sexo { get; set; }  = null !;
        [Requerid(ErrorMensage = "La direccion es requerida para el siguiente paso")]
        ...
        [Requerid(ErrorMensage = "Es requerido su correo electronico para el siguiente paso")]
